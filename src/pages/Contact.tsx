...
import { Mail, Phone, MapPin, Send, MessageSquare, Clock, CheckCircle, Calendar, Video, AlertCircle } from 'lucide-react';
...
export const Contact: React.FC = () => {
  ...
  const openWhatsApp = () => {
    window.open('https://wa.me/94779753202?text=Hello! I\'m interested in your services.', '_blank');
  };

  const openCalendly = () => {
    window.open('https://calendly.com/nesturelabs/consultation', '_blank');
  };
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Yes, we offer 24/7 support and maintenance packages to ensure your solution runs smoothly after launch.'
    },
    {
      question: 'What technologies do you work with?',
      answer: 'We work with modern technologies including React, Node.js, Flutter, Python, AI/ML frameworks, and cloud platforms.'
    },
    {
      question: 'Can you work with our existing team?',
      answer: 'Absolutely! We can integrate with your existing team or work as an extension of your development capabilities.'
    }
  ];
  ...
  const structuredData = {
    ...
    "description": "Get in touch with Nesturelabs for web development, mobile apps, and AI solutions. Multiple ways to reach us including phone, email, WhatsApp, and video calls.",
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            >
              ...
              <p className="text-lg sm:text-xl lg:text-2xl text-gray-700 dark:text-gray-300 mb-8 leading-relaxed">
                Ready to start your project? Let's discuss how we can help you achieve your goals with cutting-edge technology solutions
              </p>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 max-w-2xl mx-auto">
                ...
                <motion.div 
                  ...
                  whileHover={{ scale: 1.05 }}
                >
                  <div className="text-2xl lg:text-3xl font-bold text-purple-600 mb-1">Free</div>
            ...
            >
              <div className="text-center mb-16">
                <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 dark:text-white mb-4">
                  Multiple Ways to <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">Connect</span>
                </h2>
                  ...
                  <div className="space-y-6 mb-8">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-400">info@nesturelabs.com</p>
                        <p className="text-gray-600 dark:text-gray-400">support@nesturelabs.com</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-400">+94 77 975 3202</p>
                        <p className="text-gray-600 dark:text-gray-400">+94 72 975 5955</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-400">Colombo 03, Sri Lanka</p>
                      </div>
                    </div>
                  </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <input
                            ...
                            disabled={isSubmitting}
                            className={`w-full bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-gray-300 px-4 py-3 rounded-lg border transition-all ${
                              submissionStatus === 'error' && (!formData.email.trim() || !isValidEmail(formData.email))
                                ? 'border-red-500 focus:ring-red-500' 
                                : 'border-gray-300 dark:border-gray-600 focus:ring-blue-500'
                            } focus:outline-none focus:ring-2 disabled:opacity-50 disabled:cursor-not-allowed`}
