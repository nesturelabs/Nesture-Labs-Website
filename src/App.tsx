...
// Analytics tracker - fires page_view on client-side route changes
      ...
      <ThemeProvider>
        <Router>
          <div className="min-h-screen bg-white dark:bg-gray-900 transition-colors duration-300">
            ...
            {/* Analytics tracker must be inside Router so useLocation() works */}
            <AnalyticsTracker />
            ...
            {/* Footer, floating UI and socials */}
            <Footer />
            <FloatingElements />
            <SocialMediaBar />
          </div>
